...
namespace Engine.Renderable
{
    ...
    public class ImGuiRenderer : IDisposable
    {
        ...
        public ImGuiRenderer(GraphicsDevice gd, OutputDescription outputDescription, IView view, IInputContext input)
            : this(gd, outputDescription, view, input, ColorSpaceHandling.Legacy) { }
