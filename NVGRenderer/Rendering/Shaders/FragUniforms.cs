...
namespace NVGRenderer.Rendering.Shaders
{
    ...
    internal struct FragUniforms
    {
        ...
        public FragUniforms(Paint paint, Scissor scissor, float width, float fringe, float strokeThr, NvgRenderer renderer)
        {
        ...
        public FragUniforms(Paint paint, Scissor scissor, float fringe, NvgRenderer renderer)
